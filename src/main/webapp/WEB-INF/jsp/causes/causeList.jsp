	...
	<table id="causesTable" class="table table-striped">
		<thead>
			<tr>
				...
				<th style="width: 200px;">BudgetAchieved</th>
				<th style="width: 200px;">BudgetTarget</th>
            ...
            <tr>
					...
					<c:if test="${!entry.key.isClosed}">
						<td><spring:url value="causes/{causeId}/donations/new" var="createUrl">
   							...
   							<a href="${fn:escapeXml(createUrl)}" class="btn btn-default">CreateDonation</a>
						</td>
					</c:if>
					<td><spring:url value="/causes/{causeId}" var="detailsUrl">
       						<spring:param name="causeId" value="${entry.key.id}"/>
    					</spring:url>
   						<a href="${fn:escapeXml(detailsUrl)}" class="btn btn-default">CauseDetails</a>
					</td>
				</tr>
	...
	<table class="table-buttons">
		<tr>
			<td><a class="btn btn-default" style="margin-right: 10px"
				href='<spring:url value="/causes/new" htmlEscape="true"/>'>Add Cause</a></td>
		</tr>
	</table>
</petclinic:layout>
